function devAssembly_simVrev(index)
%{
...
st = dbstack;
funcname = st.name;
outpath = fullfile(datpath, [funcname '_' neurogenesis_shape]);
if ~exist(outpath, 'dir')
    mkdir(outpath);
end


%% Temporary add code in lines 41-43

index = str2double(index);

load('inds_remaining.mat')
index = inds_remaining(index);
outfile = fullfile(outpath,sprintf('devSim_%d.mat', index));
